  datafile<-"/home/corey/Documents/Boyson_lab_work/datafile/vdjtool_output/B6-3_Lung_SlamF1_S5_DV7_vdj_out.fancyspectra.txt"
  colorfile<-"/home/corey/Documents/Boyson_lab_work/datafile/slam_colorkey/s5.csv"
  ...
  p <- ggplot(df.m, aes(x=Len, y=value, fill=Clonotypes))+
    ...
    ggtitle("B6-3 SlamF1 TRDV7 Clonotype Usage in the
            Lung ")
    theme(
  ...
  p
  ggsave("/home/corey/Documents/Boyson_lab_work/datafile/vdj_to_r_graphs/B6-3_Slam_F1_Lung_figure.pdf", height=9, width=16, units='in', dpi = 300, device='eps')
