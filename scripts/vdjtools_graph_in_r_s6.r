datafile <- "/home/corey/Documents/Boyson_lab_work/datafile/vdjtool_output/Thymus1NEG_S6.fancyspectra.txt"
colorfile <- "/home/corey/Documents/Boyson_lab_work/datafile/vdjtoR_colorkey/s6_colorkey.csv"
library(dplyr)
library(ggplot2)
library(readr)
...
p
ggsave("/home/corey/Documents/Boyson_lab_work/datafile/vdj_to_r_graphs/Thymus1NEG_S6_figure.pdf", height = 9, width = 16, units = 'in', dpi = 300, device = 'eps')
