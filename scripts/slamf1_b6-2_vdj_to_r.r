  datafile<-"/home/corey/Documents/Boyson_lab_work/datafile/vdjtool_output/B6-2_Lung_SlamF1_S3_DV7_vdj_out.fancyspectra.txt"
  colorfile<-"/home/corey/Documents/Boyson_lab_work/datafile/slam_colorkey/s3.csv"
  ...
  p <- ggplot(df.m, aes(x=Len, y=value, fill=Clonotypes))+
    ...
    ggtitle("B6-2 SlamF1 TRDV7 Clonotype Usage in the
            Lung ")
    theme(
  ...
  p
  ggsave("/home/corey/Documents/Boyson_lab_work/datafile/vdj_to_r_graphs/B6-2_Slam_F1_Lung_figure.pdf", height=9, width=16, units='in', dpi = 300, device='eps')
